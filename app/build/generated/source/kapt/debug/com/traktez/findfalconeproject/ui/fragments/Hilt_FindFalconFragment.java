...
public abstract class Hilt_FindFalconFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FindFalconFragment() {
    super();
  }

  Hilt_FindFalconFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FindFalconFragment_GeneratedInjector) this.generatedComponent()).injectFindFalconFragment(UnsafeCasts.<FindFalconFragment>unsafeCast(this));
    }
  }
